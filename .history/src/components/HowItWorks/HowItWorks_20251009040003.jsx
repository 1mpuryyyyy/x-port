            ...
            <div className={styles.stepsContainer}>
                {stepsData.map((step, index) => {
                    ...
                    const circleClassName = [
                        ...
                        (isCompleted || isCurrent) && index >= 0 ? styles.quarter3 : '',
                        (isCompleted || isCurrent) && index >= 1 ? styles.quarter1 : '',
                        (isCompleted || isCurrent) && index >= 2 ? styles.quarter2 : '',
                        (isCompleted || isCurrent) && index >= 3 ? styles.quarter3 : '',
