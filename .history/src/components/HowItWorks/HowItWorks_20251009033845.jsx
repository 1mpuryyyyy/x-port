...
// Данные для каждого шага. Можно вынести в отдельный файл или получать как props.
const stepsData = [
  {
    title: 'Регистрация',
    ...
    <div className={styles.wrapper}>
      ...
      <div className={styles.stepsContainer}>
        {stepsData.map((step, index) => {
          ...
          const isCompletedFinal = isFinalStep && sliderValue >= 100;

          // Динамический стиль для круга с номером
          const circleStyle = isCurrent && !isFinalStep
            ? { '--progress-angle': `${(sliderValue % 20) * 18}deg` } as React.CSSProperties
            : {};
