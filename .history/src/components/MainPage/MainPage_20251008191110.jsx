                ...
                <div className={style.header__right}>
                    ...
                    <div className={style.calculator}>
                        ...
                        <div>
                            ...
                            <input type="text" id="amount" placeholder="Например, 25 000 $" />
                            <label htmlFor="direction">Сумма сделки</label>
                            <input type="text" id="direction" placeholder="Например, 25 000 $" />
                        </div>
                    </div>
                </div>
            </div>
