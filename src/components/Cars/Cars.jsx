...
export const Cars = () => {
    const stepsData = [
        ...
        { title: 'Выбор машины', description: 'Вы можете выбрать байера из нашего каталога или привлечь своего, предварительно согласовав его кандидатуру.' },
    ...
    return (<div className={style.container}>
        ...
        <div className={`${style.buyers} ${style.cars}`}>
