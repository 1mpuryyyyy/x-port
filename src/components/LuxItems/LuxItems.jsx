...
export const LuxItems = () => {
    const stepsData = [
        { title: 'Регистрация', description: 'Вы заходите на наш сайт и проходите простую регистрацию — это займёт всего несколько минут.' },
        {
            title: 'Выбор товара', description: <>
                Вы можете выбрать байера из нашего каталога или <a href='https://t.me/xport_manager' className={style.highlight} target='_blank'>привлечь своего, предварительно согласовав его кандидатуру</a>.
            </>
        },
    ...
    return (<div className={style.container}>
        <div className={style.header} id="about">
            <div className={style.header__left}>
                ...
                <div className={style.header__left__buttons}>
                    <a className={style.greenButton} onClick={(e) => handleAnchorClick('lux_buyers', e)}><p>Начать сделку </p> <img className={style.arrow} src={arr} /></a>
                </div>
            </div>
        ...
        <div className={`${style.buyers} ${style.lux}`} id='lux_buyers'>
